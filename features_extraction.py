...
def main(url):
    ...
    # with open('markup.txt', encoding="utf8") as file:
    with open('markup.txt', mode="r", encoding="utf-8") as file:
    ...
    statusInWords = []
    for i, num in enumerate(status):
        if num == 1:
            statusInWords.append("Legitimate")
        elif num == 0:
            statusInWords.append("Suspicious")
        else:
            statusInWords.append("Phishing")
    ...
    print(f"\n1. Having IP address =>{statusInWords[0]}\n2. URL Length =>{statusInWords[1]}\n3. URL Shortening service =>{statusInWords[2]}\n4. Having @ symbol =>{statusInWords[3]}")
    print(f"5. Having double slash =>{statusInWords[4]}\n6. Having dash symbol(Prefix Suffix) =>{statusInWords[5]}\n7. Having multiple subdomains =>{statusInWords[6]}")
    print(f"8. Domain Registration Length =>{statusInWords[7]}\n9. Favicon =>{statusInWords[7]}\n10. HTTP or HTTPS token in domain name =>{statusInWords[9]}")
    print(f"11. Request URL =>{statusInWords[10]}\n12. URL of Anchor =>{statusInWords[11]}\n13. Links in tags =>{statusInWords[12]}\n14. SFH =>{statusInWords[13]}\n15. Submitting to email =>{statusInWords[14]}\n16. Abnormal URL =>{statusInWords[15]}")
    print(f"17. IFrame =>{statusInWords[16]}\n18. Age of Domain =>{statusInWords[17]}\n19. DNS Record =>{statusInWords[18]}\n20. Web Traffic =>{statusInWords[19]}\n21. Google Index =>{statusInWords[20]}\n22. Statistical Reports =>{statusInWords[21]} \n")
