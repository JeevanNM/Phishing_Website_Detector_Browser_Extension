# Purpose - This file is used to create a classifier and store it in a .pkl file. 
...
joblib.dump(clf4, 'classifier/random_forest.pkl')

def mainp(newar):
  if(newar[1]==-1 or newar[1]==0 or newar[6]==-1 or newar[8]==-1 or newar[12]==-1 or newar[13]==0  ) :
        return int(-1)
  else:
        return int(1)
